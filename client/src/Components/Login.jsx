...
const Login = () => {
    ...
    try {
      if (state === 'Login') {
        ...
        if (data.success) {
          ...
          localStorage.setItem('token', data.token)  // Fixed: was using getItem instead of setItem
          setToken(data.token)
          setUser(data.user)
          setShowLogin(false)
          toast.success('Logged in successfully!')  // Add success message
        } else {
        ...
        if (data.success) {
          ...
          setUser(data.user)
          setShowLogin(false)
          toast.success('Account created successfully!')  // Add success message
        } else {
          toast.error(data.message)
        }
      }
  ...
  return (
    <motion.div onSubmit={onSubmitHandler}
